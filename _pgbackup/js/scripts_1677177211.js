...
document.querySelector('[instruments__tabs-triggers__item="#tab-11"]').classList.add('instruments__tabs-triggers__item--active');
...
document.querySelector('[i__tabs-triggers__item="#tab-21"]').classList.add('i__tabs-triggers__item--active');